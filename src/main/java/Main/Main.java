 ...
 */
    ...
    """;
        ...
        /**
         * Exibe o menu principal de movimentação de produtos. Permite ao
         * usuário escolher entre dar entrada em produtos, registrar saída ou
         ...
         * Verifica se o estoque está vazio. Caso não esteja, solicita o nome do
         * produto, valida a existência, solicita a quantidade a ser adicionada
         * e, mediante confirmação do usuário, atualiza o saldo do produto.
         */
         ...
         * solicita a quantidade de saída garantindo que o saldo final não seja
         * negativo ou zero. Mediante confirmação, atualiza o saldo do produto.
         */
        ...
        /**
         * Busca um produto no vetor de estoque pelo nome exato. Se o produto
         * for encontrado, a variável global 'marcadorBuscarNome' é atualizada
         * com o índice correspondente no vetor.
         *
